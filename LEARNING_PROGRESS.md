...
- 当前阶段：阶段 31 第一版已完成，console 支持 payment / async / approval status 筛选入口。
...
- 阶段 31 第一版已完成；下一步建议在“platform result reconciliation context”“approval action 风险提示或详情页返回入口”“日期范围或 actor 筛选”“cursor pagination”之间选择
