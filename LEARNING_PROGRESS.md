...
- 当前阶段：阶段 25 第一版已完成，operation approval 支持 cancelled / expired 生命周期状态。
...
- 读 `docs/38-stage-25-operation-approval-lifecycle.md`，理解 pending approval 如何流转到 approved / rejected / cancelled / expired 终态
- 阶段 25 第一版已完成；下一步建议在“console approve/reject 表单边界”“approval lifecycle timeline”“总数统计或 cursor pagination”“async run / platform result 更完整详情页”之间选择
