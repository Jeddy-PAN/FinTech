...
- 当前阶段：阶段 28 第一版已完成，async run 和 platform result 支持只读详情页。
...
- 读 `docs/41-stage-28-async-platform-detail-views.md`，理解 console 和 approval detail 如何继续跳转到 async run / platform result 只读详情页
- 阶段 28 第一版已完成；下一步建议在“总数统计或 cursor pagination”“console cancel / expire 表单边界”“console 筛选入口”“platform result reconciliation context”之间选择
