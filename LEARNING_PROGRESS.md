...
- 当前阶段：阶段 23 第一版已完成，operation approval 列表支持分页和排序，console approval 表格默认按申请时间倒序展示最新记录。
...
- 阶段 23 第一版已完成；下一步建议在“approval 与 async run 只读详情视图”“pending approval 过期或取消状态”“console approve/reject 表单边界”“总数统计或 cursor pagination”之间选择
