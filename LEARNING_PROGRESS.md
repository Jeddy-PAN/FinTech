...
- 当前阶段：阶段 38 第一版已完成，已新增教学版 evidence package 报告。
...
- 阶段 38 第一版已完成；下一步建议进入阶段 39：可运行交付、观测和测试矩阵
