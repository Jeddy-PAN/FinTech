...
- 读 `docs/37-stage-24-operation-approval-detail-view.md`，理解 approval 详情页如何关联 async run 和 completed platform result 摘要
- 阶段 24 第一版已完成；下一步建议在“pending approval 过期或取消状态”“console approve/reject 表单边界”“总数统计或 cursor pagination”“async run / platform result 更完整详情页”之间选择
