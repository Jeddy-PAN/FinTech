...
- 当前阶段：阶段 27 第一版已完成，operation approval 详情页支持只读 lifecycle timeline。
...
- 读 `docs/40-stage-27-approval-lifecycle-timeline.md`，理解 approval detail view 如何把申请、决策和 retry execution audit 串成只读 timeline
- 阶段 27 第一版已完成；下一步建议在“async run / platform result 更完整详情页”“总数统计或 cursor pagination”“console cancel / expire 表单边界”“console 筛选入口”之间选择
