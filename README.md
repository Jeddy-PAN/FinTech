...
2. 直接理解综合平台：先读 [labs/fintech-platform/README.md](labs/fintech-platform/README.md)，再读 [docs/38-stage-25-operation-approval-lifecycle.md](docs/38-stage-25-operation-approval-lifecycle.md) 了解当前最新 operation approval lifecycle。
