...
2. 直接理解综合平台：先读 [labs/fintech-platform/README.md](labs/fintech-platform/README.md)，再读 [docs/45-stage-32-payment-detail-reconciliation-context.md](docs/45-stage-32-payment-detail-reconciliation-context.md) 了解当前最新 payment detail reconciliation context。
