...
2. 直接理解综合平台：先读 [labs/fintech-platform/README.md](labs/fintech-platform/README.md)，再读 [docs/33-stage-20-create-operation-approval-http-endpoint.md](docs/33-stage-20-create-operation-approval-http-endpoint.md) 了解当前最新 operation approval HTTP endpoints。
