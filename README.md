...
- 当前阶段：阶段 27 第一版已完成，approval detail view 支持只读 lifecycle timeline。
...
2. 直接理解综合平台：先读 [labs/fintech-platform/README.md](labs/fintech-platform/README.md)，再读 [docs/40-stage-27-approval-lifecycle-timeline.md](docs/40-stage-27-approval-lifecycle-timeline.md) 了解当前最新 approval lifecycle timeline。
