...
2. 直接理解综合平台：先读 [labs/fintech-platform/README.md](labs/fintech-platform/README.md)，再读 [docs/42-stage-29-operation-approval-pagination-metadata.md](docs/42-stage-29-operation-approval-pagination-metadata.md) 了解当前最新 operation approval pagination metadata。
