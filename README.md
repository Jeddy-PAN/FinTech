...
2. 直接理解综合平台：先读 [labs/fintech-platform/README.md](labs/fintech-platform/README.md)，再读 [docs/41-stage-28-async-platform-detail-views.md](docs/41-stage-28-async-platform-detail-views.md) 了解当前最新 async run 和 platform result 只读详情页。
