...
2. 直接理解综合平台：先读 [labs/fintech-platform/README.md](labs/fintech-platform/README.md)，再读 [docs/43-stage-30-console-cancel-expire-actions.md](docs/43-stage-30-console-cancel-expire-actions.md) 了解当前最新 console cancel / expire approval actions。
