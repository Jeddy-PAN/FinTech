...
2. 直接理解综合平台：先读 [labs/fintech-platform/README.md](labs/fintech-platform/README.md)，再读 [docs/44-stage-31-console-filter-controls.md](docs/44-stage-31-console-filter-controls.md) 了解当前最新 console filter controls。
