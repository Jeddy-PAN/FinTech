...
2. 直接理解综合平台：先读 [labs/fintech-platform/README.md](labs/fintech-platform/README.md)，再读 [docs/39-stage-26-console-approval-actions.md](docs/39-stage-26-console-approval-actions.md) 了解当前最新 console approval actions。
